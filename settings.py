...
SOUNDS = {
    ...
    "explode": pygame.mixer.Sound(BASE_DIR / "sounds" / "mixkit-alien-blast-in-the-earth-2546.wav"),
}
...
TEXTURES = {
    ...
    "Misil": pygame.image.load(BASE_DIR / "graphics" / "Misil.png"),
    "Waterdrops": pygame.image.load(BASE_DIR / "graphics" / "Waterdrop.png"),
